...
char *previewCruiseSet		= NULL;
char *previewCruiseStart	= NULL;
char *previewCruiseStop		= NULL;
char *previewCruiseRecall	= NULL;
char *previewCruiseLoad		= NULL;
char *previewCruiseSave		= NULL;
char *previewCruiseClear	= NULL;
...
/*setting manage page*/
char *settingManageDeviceID		= NULL;
...
char *golbalDownloadFinish	= NULL;
