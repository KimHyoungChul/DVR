...
Stream_Playback* stream_playback_init(StreamType type)
{
    ...
    memset(instance->ip,0x0,sizeof(instance->ip));
    memset(instance->localOrRemoteVideoFilePath, 0x0, sizeof(instance->localOrRemoteVideoFilePath));
     
    instance->port = 0;
    instance->channel = 0;
    instance->hDvs = g_Dvs;
    instance->cbRealVideoFunc = UP_NULL;
    instance->hDevStreamHandle = UP_NULL;
    instance->hPlayUtility = UP_NULL;
...
void stream_playback_fini(Stream_Playback *instance)
{
	...
	//if(instance->videoCtx)
	{
		...
		//upui_fw_finiCtx(instance->videoCtx);
        MAC_DVS_StopRealStream(instance->hDevStreamHandle);
		instance->videoCtx = UP_NULL;
	}
...
UPSint stream_playback_setFilePath(Stream_Playback *instance, const UPSint8* path)
{
	...
	ret = 0;//upui_fw_setCtxFilePath(instance->videoCtx, path);
...
UPSint stream_playback_getFilePos(Stream_Playback *instance)
{
	...
	return 0;//upui_fw_getSrvFilePos(instance->videoCtx);
}
...
UPSint stream_playback_setFilePos(Stream_Playback *instance, UPSint pos)
{
	...
	return 0;//upui_fw_setSrvFilePos(instance->videoCtx, pos);
}
...
void stream_playback_process(void *param, void *data, int len, int dropFrame, int fps)
{
	int ret;
	int count = 0;
	int rgbLen = 0;
    ...
    ret = stream_playback_decode(instance, data, len, outData, outLineSize, &got_picture, &width, &height);
	if(got_picture > 0)
	{
...
//		}
//		else 
        if(instance->streamCtl == STREAM_FF_2X)
		{
...
UPSint stream_playback_setUsrInfo(Stream_Playback *instance, UPSint8* name, UPSint8* password)
{
	...
	return 0;//upui_fw_setCtxUsrInfo(instance->videoCtx, name, password);
}
...
UPSint stream_playback_setNetInfo(Stream_Playback *instance, UPSint8* addr, UPSint32 port, UPUint type)
{
	...
	return 0;//upui_fw_setCtxNetInfo(instance->videoCtx, addr, port, type);
}

UPSint stream_playback_setChannelNum(Stream_Playback *instance,UPUint chNum)
{
    if (instance == UP_NULL) {
        UPLOG(stream_playback_setChannelNum,("instance is NULL"));
        return -1;
    }
    
    instance->channelNum = chNum;
...
UPSint stream_playback_setDownloadFileSize(Stream_Playback *instance, UPUint size)
{
	...
	return 0;//upui_fw_setSrvFileSize(instance->videoCtx, size);
}

UPUint stream_playback_getVideoChannel(Stream_Playback *instance)
{
	return 0;//upui_fw_getCtxChannel(instance->videoCtx);
}
...
UPSint stream_playback_start(Stream_Playback *instance)
{
    ...
    instance->cbRealVideoFunc = stream_playback_process;
    
    if((hReal = MAC_DVS_OpenRealStream(g_Dvs,instance->ip,instance->port,instance->channel,hReal,instance))!= NULL)
    {
        MAC_DVS_PlayRealStream(hReal);//开启实时监控
        instance->hDevStreamHandle = (void*)hReal;
    }
...
UPSint stream_playback_stop(Stream_Playback *instance)
{
    ...
    MAC_DVS_StopRealStream(instance->hDevStreamHandle);//关闭实时监控
...
UPSint stream_playback_startRecord(Stream_Playback *instance)
{
	...
	return 0;//upui_fw_startSrvRecord(instance->videoCtx);
}
...
UPSint stream_playback_stopRecord(Stream_Playback *instance)
{
	...
	return 0;//upui_fw_stopSrvRecord(instance->videoCtx);
}
...
UPSint stream_playback_ptzUp(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_UP,NULL);
	return 0;
}
...
UPSint stream_playback_ptzDown(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_DOWN,NULL);
	return 0;
}
...
UPSint stream_playback_ptzLeft(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_LEFT,NULL);
	return 0;
}
...
UPSint stream_playback_ptzRight(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_RIGHT,NULL);
	return 0;
}
...
UPSint stream_playback_ptzZoomin(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_ZOOM_IN,NULL);
	return 0;
}
...
UPSint stream_playback_ptzZoomout(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_ZOOM_OUT,NULL);
	return 0;
}
...
UPSint stream_playback_ptzFocusFar(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_FOCUS_FAR,NULL);
	return 0;
}
...
UPSint stream_playback_ptzFocusNear(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_FOCUS_NEAR,NULL);
	return 0;
}
...
UPSint stream_playback_ptzIRISOpen(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_IRIS_OPEN,NULL);
	return 0;
}
...
UPSint stream_playback_ptzIRISClose(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_IRIS_CLOSE,NULL);
	return 0;
}
...
UPSint stream_playback_ptzCruisePreSet(Stream_Playback *instance, UPUint para)
{
    ...
    return MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_PRESET_SET,para);
}
...
UPSint stream_playback_ptzCruiseRecall(Stream_Playback *instance, UPUint para)
{
    ...
    return  MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_PRESET_GOTO,NULL);
...
UPSint stream_playback_ptzCruiseStart(Stream_Playback *instance, UPUint para)
{
	...
	return 0;//upui_fw_srvPtzCruiseStart(instance->videoCtx, para);
}
...
UPSint stream_playback_ptzCruiseClear(Stream_Playback *instance, UPUint para)
{
	...
	return 0;//upui_fw_srvPtzCruiseClear(instance->videoCtx, para);
}
...
UPSint stream_playback_ptzCruiseLoad(Stream_Playback *instance, UPUint para)
{
	...
	return 0;//upui_fw_srvPtzCruiseLoad(instance->videoCtx, para);
}
...
UPSint stream_playback_ptzCruiseSave(Stream_Playback *instance, UPUint para)
{
	...
	return 0;//upui_fw_srvPtzCruiseSave(instance->videoCtx, para);
}
...
UPSint stream_playback_ptzCruiseStop(Stream_Playback *instance, UPUint para)
{
	...
	return 0;//upui_fw_srvPtzCruiseStop(instance->videoCtx, para);
}
...
UPSint stream_playback_ptzStop(Stream_Playback *instance)
{
    ...
    MAC_DVS_PTZControl(g_Dvs,instance->channel,DVS_PTZ_CTRL_STOP,NULL);
	return 0;
}
...
void *stream_playback_AudioListPop(Stream_Playback *instance)
{
	...
	return 0;//upui_fw_srvAudioListPop(instance->videoCtx);
}
...
void *stream_playback_AudioPoolPush(Stream_Playback *instance, void *data)
{
	...
	return 0;//upui_fw_srvAudioPoolPush(instance->videoCtx, data);
}
...
/*	
	...
	instance->searchMgr = upui_fw_srvFileMgrInit_ex();
...
void playback_online_getDescription(Playback_Online *instance, UPSint8 *description)
{
	...
	else if(instance->calendaMap == 0xffff)
	{
		UPLOG(playback_online_getDescription, ("refresh fail!"));
		strcpy((char*)description, (char*)"Refresh fail!");
		return ;
	}
...
/*	UPSint ret = 0;
	...
	if(ret != 0)
	{
		if(ret == DVR_BUSY)
		{
			UPLOG(playback_online_getSearchMgr, ("DVR is busy"));
			ret = Search_DVR_BUSY;
		}
		else if(ret == DVR_NO_FILE)
		{
			UPLOG(playback_online_getSearchMgr, ("no record file this day"));
			ret = Search_DVR_NOFILE;
		}
		else
		{
			UPLOG(playback_online_getSearchMgr, ("error occur"));
			ret = Search_DVR_ERROR;
		}
...
{
	return 0;//upui_fw_srvFileMgrDownloadStop(instance->searchMgr);
}
...
UPSint playback_online_getDownloadSize(Playback_Online *instance)
{
	...
	return 0;//upui_fw_srvFileMgrGetDstSize(instance->searchMgr);
}
...
UPSint playback_online_setSavePath(Playback_Online *instance, UPSint8 *savePath)
{
	...
	return 0;//upui_fw_srvFileMgrSetSavePath(instance->searchMgr, savePath);
}
...
UPSint playback_online_setSaveName(Playback_Online *instance, UPSint8 *saveName)
{
	...
	return 0;//upui_fw_srvFileMgrSetSaveName(instance->searchMgr, saveName);
}
...
UPSint playback_online_getPrecent(Playback_Online *instance)
{
	...
	return 0;//upui_fw_srvFileMgrGetPrecent(instance->searchMgr);
}
...
UPSint playback_online_getCacheFileList(Playback_Online *instance, UPSint8 *cachePath)
{
	...
	instance->cacheFileList = kt_fileMgr_getRecFileInFS((char*)cachePath, ".h264", 0xff, 1, &count);
