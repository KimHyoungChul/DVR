...
typedef struct _mobilesetting_{
	...
	unsigned char Net3GType;
	unsigned char reservel[1];
	
	unsigned short port;
	unsigned short reservelport;
	char usename[20];
	char usepwd[20];
	//unsigned char reserve[24];
	char Net3GTelephone[8];
	char Net3GAccount[8];
	char Net3GPassword[8];
...
typedef struct _keyparameter_{
	...
	unsigned char reserve[116 - 3 - 24 - 24 - 24 - 24];
	unsigned char TelFor3G[24];
	unsigned char AccountFor3G[24];
	unsigned char PwdFor3G[24];
	unsigned char APNFOR3G[24];
