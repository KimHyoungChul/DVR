...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Developer/usr/ --disable-debug --enable-static --enable-swscale_alpha --enable-ffplay --enable-gpl --disable-shared --disable-zlib --disable-bzlib --disable-ffmpeg --disable-mmx --arch=x86_64
...
SRC_PATH="/Users/kelvin/Develop/ffmpeg-dvr/ffmpeg-0.6.1"
SRC_PATH_BARE=/Users/kelvin/Develop/ffmpeg-dvr/ffmpeg-0.6.1
BUILD_ROOT="/Users/kelvin/Develop/ffmpeg-dvr/ffmpeg-0.6.1"
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS=   -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
