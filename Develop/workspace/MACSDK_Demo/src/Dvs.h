...
public:
	...
	virtual UNS32 QueryRecordFile(DVS_TIME dtStartTime, DVS_TIME dtEndTime, UNS8 type, LPDVS_RECORDFILE_LIST lpRecordfileList) = 0;
	...
	virtual void SetRemoteDataCallBack(fDataCallBack cbRemoteFunc, UNS32 dwUser) = 0;
