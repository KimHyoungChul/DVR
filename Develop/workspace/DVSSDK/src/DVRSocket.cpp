...
UNSL32 __attribute__((stdcall)) HeartBeat(LPVOID lpvoid);
UNSL32 __attribute__((stdcall)) RecvMessageThread(LPVOID lpvoid);
...
UNSL32 __attribute__((stdcall)) RecvMessageThread(LPVOID lpvoid)//UNS32 DVRSocket::RecvMessageThread()
{
	DVRSocket *pSocket = (DVRSocket*)lpvoid;
