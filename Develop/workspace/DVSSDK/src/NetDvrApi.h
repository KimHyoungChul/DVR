...
//typedef __int64			S64;//64 bits
typedef long				S64;//64 bits/*wuzy-12.4.16*/
...
//typedef unsigned __int64	UNS64;//64 bits
typedef unsigned long		UNS64;//64 bits/*wuzy-12.4.16*/
...
struct DVS_RECSETUP//对应RECORDSETUP
{
...
struct DVS_CAMERAOPTS//对应CAMERASETUP
{
...
struct DVS_CAMERASETUP
{
	DVS_CAMERAOPTS opts[DVS_MAX_SOLO_CHANNEL_16 + 1];
};

struct DVS_ES_WARNING//对应ES_WARNING
{
...
struct DVS_ES_MOTION//对应ES_MOTION
{
...
struct DVS_ES_HARDDISK//对应ES_HARDDISK
{
	UNS32	ContinueTime;//持续录像时间	单位是：秒
...
struct DVS_ES_VIDEOLOSS//对应ES_VIDEOLOSS
{
	UNS32	ContinueTime;//持续录像时间	单位是：秒
...
struct DVS_EVENTSETUP//对应EVENTSETUP
{
...
struct DVS_VGASETUP//对应VGASETUP
{
...
struct DVS_NETSETUP_VER1//对应NETSETUP
{
	UNS32	IP; //IP 地址
	UNS32	NetMask;	//子网掩码
	UNS32	Gateway;	//网关地址
...
struct DVS_NETSETUP_VER2//对应NETSETUP
{
	UNS32	IP; //IP 地址
	UNS32	NetMask;	//子网掩码
	UNS32	Gateway;	//网关地址
...
struct DVS_NETSETUP_VER3//对应NETSETUP
{
	UNS32	IP; //IP 地址
	UNS32	NetMask;	//子网掩码
	UNS32	Gateway;	//网关地址
...
struct DVS_NETSETUP_VER4//对应NETSETUP
{
	UNS32	IP; //IP 地址
	UNS32	NetMask;	//子网掩码
	UNS32	Gateway;	//网关地址
...
struct DVS_SYSSETUP//对应SYSSETUP
{
	UNS32	            MagicNum;	                    /*校验值*/
...
struct DVS_USEROPTS//对应USERSETUP
{
...
//typedef void (__stdcall *fMessCallBack)(UNS32 dwCommand, HANDLE hDvs, S8 *pBuf, UNS32 dwBufLen, S8 *pchDeviceIP, UNS32 wDevicePort, UNS32 dwUser);
...
//云台控制函数
 UNS32	 DVS_PTZControl(HANDLE hDvs, UNS8 channel, UNS32 dwPTZCommand, UNS32 dwParam = 0);
...
//远程文件下载
 UNS32	 DVS_DumpOpen(HANDLE hDvs, S8 *pDumpFile, S8 *pSaveAs, UNS32 startTime, UNS32 endTime, UNS32 chnnlMask = 0xFFFF);
