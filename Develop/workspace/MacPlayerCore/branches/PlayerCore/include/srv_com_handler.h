...
#define VMS_RECV_ERROR			0x80030001
#define VMS_SEND_ERROR			0x80030002
	
#define FILE_SEARCH_NOTFOUND	0x00020014
#define FILE_SEARCH_NOTMEM		0x00020015
	
#define RME_OTHER_TASKGOING		0x80F00003
#define RME_FULLUSE_VIDEOTHREAD	0x80F00004
